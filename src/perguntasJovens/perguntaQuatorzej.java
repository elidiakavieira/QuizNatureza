...
public class perguntaQuatorzej extends javax.swing.JDialog {

    public perguntaQuatorzej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O lixo é um problema mundial e muitos materiais levam anos para");
        ...
        rdA.setText(" A) Levam mais de 3 mil anos");
        ...
        rdB.setText(" B) Levam 2 mil anos");
        ...
        jLabel3.setText("se decompor. Os vidros:");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respQuatorzej rQuatorzej = new respQuatorzej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaQuatorzej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaQuatorzej dialog = new perguntaQuatorzej(new javax.swing.JFrame(), true);
