...
public class perguntaDezenovej extends javax.swing.JDialog {

    public perguntaDezenovej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdB.setText(" B) Em grandes cachoeiras");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezenovej rDezenovej = new respDezenovej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezenovej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezenovej dialog = new perguntaDezenovej(new javax.swing.JFrame(), true);
