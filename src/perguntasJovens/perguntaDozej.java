...
public class perguntaDozej extends javax.swing.JDialog {

    public perguntaDozej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Mais da metade do lixo de nossa casa pode ser reciclado. ");
        ...
        rdA.setText(" A) Separar os materiais recicláveis do lixo orgânico");
        ...
        rdB.setText(" B) Juntar todos os lixos em um só saco");
        ...
        rdC.setText(" C) Armazenar somente lixo orgânico");
        ...
        jLabel3.setText("Para contribuir com isso devemos:");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDozej rDozej = new respDozej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDozej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDozej dialog = new perguntaDozej(new javax.swing.JFrame(), true);
