...
public class perguntaDezesseisj extends javax.swing.JDialog {

    public perguntaDezesseisj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O que é o tsunami?");
        ...
        rdA.setText(" A) Uma onda gigante de terra");
        ...
        rdB.setText(" B) Uma onda gigante de ar");
        ...
        rdC.setText(" C) Uma onda gigante de água");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezesseisj rDezesseisj = new respDezesseisj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezesseisj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezesseisj dialog = new perguntaDezesseisj(new javax.swing.JFrame(), true);
