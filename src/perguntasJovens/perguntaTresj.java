...
public class perguntaTresj extends javax.swing.JDialog {

    public perguntaTresj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Para construir uma casa, existem soluções sustentáveis como:");
        ...
        rdA.setText(" A) Comprar madeiras de procedência duvidosa");
        ...
        rdB.setText(" B) Aproveitar a água da chuva para regar as plantas");
        ...
        rdC.setText(" C) Utilizar aquecedor elétrico nos chuveiros");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respTresj rTresj = new respTresj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaTresj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaTresj dialog = new perguntaTresj(new javax.swing.JFrame(), true);
