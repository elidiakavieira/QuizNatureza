...
public class perguntaNovej extends javax.swing.JDialog {

    public perguntaNovej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 9");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("Na natureza, o pluviômetro mede a quantidade do quê");
        ...
        rdA.setText(" A) Mede a quantidade de chuvas ");
        ...
        rdB.setText(" B) A quantidade de agua no mar");
        ...
        rdC.setText("C) A quantidade de raios em uma tempestade");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respNovej rNovej = new respNovej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaNovej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaNovej dialog = new perguntaNovej(new javax.swing.JFrame(), true);
