...
public class perguntaSetej extends javax.swing.JDialog {

    public perguntaSetej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 7");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("Para poupar muitas árvores e florestas devemos:");
        ...
        rdA.setText(" A) Comprar menos jornal");
        ...
        rdB.setText(" B) Reciclar jornais, revistas e papéis. ");
        ...
        rdC.setText(" C) Reciclar latas de metal");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respSetej rSetej = new respSetej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaSetej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaSetej dialog = new perguntaSetej(new javax.swing.JFrame(), true);
