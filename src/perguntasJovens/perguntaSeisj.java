...
public class perguntaSeisj extends javax.swing.JDialog {

    public perguntaSeisj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Os chamados “Produtos verdes” são:");
        ...
        rdA.setText(" A) Chás e plantas em geral");
        ...
        rdC.setText(" C) Produzidos com tecnologia menos agressiva ao meio ambiente");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respSeisj rSeisj = new respSeisj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaSeisj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaSeisj dialog = new perguntaSeisj(new javax.swing.JFrame(), true);
