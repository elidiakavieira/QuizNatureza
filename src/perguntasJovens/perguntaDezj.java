...
public class perguntaDezj extends javax.swing.JDialog {

    public perguntaDezj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 10");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("O que está acontecendo com a temperatura do planeta Terra?");
        ...
        rdA.setText(" A) A temperatura está ficando agradável");
        ...
        rdB.setText(" B) A temperatura está diminuindo muito rápido");
        ...
        rdC.setText(" C) A temperatura está aumentando cada vez mais ");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezj rDezj = new respDezj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezj dialog = new perguntaDezj(new javax.swing.JFrame(), true);
