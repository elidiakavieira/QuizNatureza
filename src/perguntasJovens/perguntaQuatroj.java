...
public class perguntaQuatroj extends javax.swing.JDialog {

    public perguntaQuatroj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O aquecimento global é:");
        ...
        rdA.setText(" A) O gasto excessivo de água");
        ...
        rdB.setText(" B) Quando a temperatura dos oceanos diminui");
        ...
        rdC.setText(" C) Um fenômeno climático decorrente de causas naturais e humanas");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respQuatroj rQuatroj = new respQuatroj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaQuatroj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaQuatroj dialog = new perguntaQuatroj(new javax.swing.JFrame(), true);
