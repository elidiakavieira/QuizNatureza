...
public class perguntaDoisj extends javax.swing.JDialog {

    public perguntaDoisj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Uma das soluções para se diminuir o aquecimento global é");
        ...
        rdA.setText(" A) Diminuir o uso de combustíveis fósseis e aumentar o de biocombustíveis ");
        ...
        rdB.setText(" B) Utilizar ao máximo a energia através de termoelétricas");
        ...
        rdC.setText(" C) Apoiar a prática de desmatamento nas florestas ");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDoisj rDoisj = new respDoisj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDoisj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDoisj dialog = new perguntaDoisj(new javax.swing.JFrame(), true);
