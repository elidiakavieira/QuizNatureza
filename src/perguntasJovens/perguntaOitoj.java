...
public class perguntaOitoj extends javax.swing.JDialog {

    public perguntaOitoj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 8");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("Uma das formas de ajudar o nosso planeta é reciclando o lixo.");
        ...
        rdA.setText(" A) É só deixar o lixo na rua para o caminhão recolher");
        ...
        rdB.setText(" B) Precisamos juntar todo o lixo num caminhão e levar num terreno");
        ...
        rdC.setText("C) Na hora de jogar o lixo fora, precisamos separar os papéis");
        ...
        jLabel3.setText(" Como podemos ajudar?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respOitoj rOitoj = new respOitoj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaOitoj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaOitoj dialog = new perguntaOitoj(new javax.swing.JFrame(), true);
