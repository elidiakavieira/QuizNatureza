...
public class perguntaTrezej extends javax.swing.JDialog {

    public perguntaTrezej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("A queima de lixo libera até 27 metais pesados e gases,");
        ...
        jLabel3.setText("isso contribui para a formação:");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respTrezej rTrezej = new respTrezej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaTrezej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaTrezej dialog = new perguntaTrezej(new javax.swing.JFrame(), true);
