...
public class perguntaDezessetej extends javax.swing.JDialog {

    public perguntaDezessetej(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezessetej rDezessetej = new respDezessetej (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezessetej.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezessetej dialog = new perguntaDezessetej(new javax.swing.JFrame(), true);
