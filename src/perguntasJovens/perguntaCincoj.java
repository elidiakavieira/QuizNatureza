...
public class perguntaCincoj extends javax.swing.JDialog {

    public perguntaCincoj(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Definimos como energia sustentável:");
        ...
        rdA.setText("A) Quando diminuímos o gasto de energia elétrica");
        ...
        rdB.setText("B) A energia que pode ser utilizada  sem prejudicar o meio ambiente");
        ...
        rdC.setText("C) A energia que é gerada através do vento");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respCincoj rCincoj = new respCincoj (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaCincoj.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaCincoj dialog = new perguntaCincoj(new javax.swing.JFrame(), true);
