...
public class perguntaDezenovec extends javax.swing.JDialog {

    public perguntaDezenovec(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Qual é a vantagem da reciclagem?");
        ...
        rdA.setText("A) Reaproveitar os recursos da natureza.");
        ...
        rdB.setText("B) Não tem nenhuma vantagem.");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezenovec rDezenovec = new respDezenovec (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezenovec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezenovec dialog = new perguntaDezenovec(new javax.swing.JFrame(), true);
