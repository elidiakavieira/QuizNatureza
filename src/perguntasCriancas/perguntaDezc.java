...
import respostasCrianças.respDezc;

public class perguntaDezc extends javax.swing.JDialog {

    public perguntaDezc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Quais os problemas enfrentados, em relação a grande");
        ...
        rdA.setText("A) Nenhum, pois os garis limpam tudo.");
        ...
        rdB.setText("B) Bueiros entupidos, alagamento, etc.");
        ...
        jLabel3.setText(" quantidade de lixos nas ruas?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezc rDezc = new respDezc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezc dialog = new perguntaDezc(new javax.swing.JFrame(), true);
