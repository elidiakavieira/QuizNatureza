...
public class perguntaQuatorzec extends javax.swing.JDialog {

    public perguntaQuatorzec(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdA.setText("A) Sim, algumas todos os dias e outras 1 ou 2 vezes por semana");
        ...
        rdB.setText("B) Não precisa regar somente deixar na chuva");
        ...
        jLabel3.setText("precisa-se regar?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respQuatorzec rQuatorzec = new respQuatorzec (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaQuatorzec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaQuatorzec dialog = new perguntaQuatorzec(new javax.swing.JFrame(), true);
