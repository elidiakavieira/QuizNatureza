...
import respostasCrianças.respQuatroc;

public class perguntaQuatroc extends javax.swing.JDialog {

    public perguntaQuatroc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Qual a cor da lata de lixo do plástico?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respQuatroc rQuatroc = new respQuatroc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaQuatroc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaQuatroc dialog = new perguntaQuatroc(new javax.swing.JFrame(), true);
