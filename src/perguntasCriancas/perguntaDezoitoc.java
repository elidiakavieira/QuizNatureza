...
public class perguntaDezoitoc extends javax.swing.JDialog {

    public perguntaDezoitoc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdA.setText("A) Nada, pois elas têm um sistema de irrigação");
        ...
        rdB.setText("B) Morrem na falta de água, mesmo tendo um sistema de irrigação");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezoitoc rDezoitoc = new respDezoitoc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezoitoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezoitoc dialog = new perguntaDezoitoc(new javax.swing.JFrame(), true);
