...
public class perguntaTrezec extends javax.swing.JDialog {

    public perguntaTrezec(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 13");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("Qual a importância das árvores para o meio ambiente.");
        ...
        rdA.setText("A) Nenhuma, pois só atrapalha na construção de casas e na visão.");
        ...
        rdB.setText("B) Muito importante, elas geram o oxigênio para nossa existência.");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respTrezec rTrezec = new respTrezec (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaTrezec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaTrezec dialog = new perguntaTrezec(new javax.swing.JFrame(), true);
