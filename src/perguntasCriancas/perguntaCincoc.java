...
import respostasCrianças.respCincoc;

public class perguntaCincoc extends javax.swing.JDialog {

    public perguntaCincoc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O que é ecologia?");
        ...
        rdA.setText("A) É aprender a economizar a energia");
        ...
        rdB.setText("B) É o estudo do lugar onde se vive");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respCincoc rCincoc = new respCincoc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaCincoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaCincoc dialog = new perguntaCincoc(new javax.swing.JFrame(), true);
