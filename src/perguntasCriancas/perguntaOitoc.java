...
import respostasCrianças.respOitoc;

public class perguntaOitoc extends javax.swing.JDialog {

    public perguntaOitoc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O que é meio ambiente?");
        ...
        rdA.setText("A) Lugar em que vivemos com saúde");
        ...
        rdB.setText("B) Mata Floresta, vegetação em geral ");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respOitoc rOitoc = new respOitoc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaOitoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaOitoc dialog = new perguntaOitoc(new javax.swing.JFrame(), true);
