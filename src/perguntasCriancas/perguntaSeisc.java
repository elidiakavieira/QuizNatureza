...
import respostasCrianças.respSeisc;

public class perguntaSeisc extends javax.swing.JDialog {

    public perguntaSeisc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pergunta 6");

        jLabel2.setFont(new java.awt.Font("Arial", 1, 24)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(119, 143, 193));
        jLabel2.setText("Qual a definição de poluição?");
        ...
        rdA.setText("A) Jogar lixos na rua, poluir o mar, etc.");
        ...
        rdB.setText("B) Sempre jogar lixo no lixo, não jogar lixo no mar e etc.");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respSeisc rSeisc = new respSeisc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaSeisc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaSeisc dialog = new perguntaSeisc(new javax.swing.JFrame(), true);
