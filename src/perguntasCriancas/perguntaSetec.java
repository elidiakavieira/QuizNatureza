...
import respostasCrianças.respSetec;

public class perguntaSetec extends javax.swing.JDialog {

    public perguntaSetec(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O meio ambiente é um elemento fundamental para nós?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respSetec rSetec = new respSetec (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaSetec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaSetec dialog = new perguntaSetec(new javax.swing.JFrame(), true);
