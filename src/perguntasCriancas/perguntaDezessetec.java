...
public class perguntaDezessetec extends javax.swing.JDialog {

    public perguntaDezessetec(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Como ajudar a preservar a natureza?");
        ...
        rdA.setText("A) Reciclar, não jogar lixo na rua, cuidar das plantinhas, etc.");
        ...
        rdB.setText("B) Podar as árvores, jogar o lixo na rua para o lixeiro recolher.");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDezessetec rDezessetec = new respDezessetec (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezessetec.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezessetec dialog = new perguntaDezessetec(new javax.swing.JFrame(), true);
