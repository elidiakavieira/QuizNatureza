...
import respostasCrianças.respDoisc;

public class perguntaDoisc extends javax.swing.JDialog {

    public perguntaDoisc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Se todos nós usássemos o lixo reciclável para fazer");
        ...
        rdA.setText("A) Não, pois a poluição só cresce e somos nós quem produzimos. ");
        ...
        rdB.setText("B) Sim, pois assim não sobraria nada para a poluição.");
        ...
        jLabel3.setText(" arte através do lixo, a poluição acabaria?");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDoisc rDoisc = new respDoisc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDoisc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDoisc dialog = new perguntaDoisc(new javax.swing.JFrame(), true);
