...
public class perguntaDezesseisc extends javax.swing.JDialog {

    public perguntaDezesseisc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        rdA.setText("A) Jogando lixo nas ruas e mares e poluindo parques");
        ...
        rdB.setText("B) não jogando lixo nas ruas,mares e não poluir parques");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respDEzesseisc rDEzesseisc = new respDEzesseisc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaDezesseisc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaDezesseisc dialog = new perguntaDezesseisc(new javax.swing.JFrame(), true);
