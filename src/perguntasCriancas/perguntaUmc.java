...
import respostasCrianças.respUmc;

public class perguntaUmc extends javax.swing.JDialog {

    public perguntaUmc(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("O que é coleta seletiva?");
        ...
        rdA.setText("A) Trabalho conhecido como lixeiro");
        ...
        rdB.setText("B) É o termo utilizado para recolhimento dos materiais");
    ...
    private void btnRespActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRespActionPerformed
        ...
        respUmc rUmc = new respUmc (null,true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(perguntaUmc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                perguntaUmc dialog = new perguntaUmc(new javax.swing.JFrame(), true);
